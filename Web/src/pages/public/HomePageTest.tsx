      ...
      sections.forEach((section, sectionIndex) => {
        if (section.projects && section.projects.length > 0) {
          section.projects.forEach((project, projectIndex) => {
            ...
            if (!animationExists) {
              console.warn(`Unknown animation: ${project.animation}`);
            }
            if (!speedExists) {
              console.warn(`Unknown speed: ${project.animationSpeed}`);
            }
            if (!triggerExists) {
              console.warn(`Unknown trigger: ${project.animationTrigger}`);
            }
          });
        }
      });
